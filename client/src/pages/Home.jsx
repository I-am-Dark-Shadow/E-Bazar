                  ...
                  <div
                    ...
                    <div className="bg-white min-h-32 rounded">
                      <div className="flex flex-col items-center justify-center text-center">
                        ...
                        />
                        <p className="font-mono text-gray-800 lg:font-semibold font-semibold py-2 lg:p-2 lg:text-base text-sm text-ellipsis lg:line-clamp-3 line-clamp-2">{cat?.name}</p>
                      </div>
                    </div>
                  </div>
                )
