  ...
  return (
    <footer className='lg:bg-gray-900 lg:text-white text-slate-800 p-[17.5px] '>
      <div className='container mx-auto text-center flex flex-col lg:flex-row lg:justify-between gap-2 text-base'>
        <p>&copy; 2025 E-Bazar. All rights reserved.</p>
        ...
        <div className="flex items-center justify-center gap-4 text-2xl">
          ...
          <a href="www.linkedin.com/in/suvrodip-chakroborty-0aa21b264" className="hover:text-blue-400">
            <FaLinkedin />
          </a>
          ...
          <a href="https://suvrodip-chakroborty.vercel.app/" className="hover:text-emerald-500">
            <TbWorldWww />
          </a>
        </div>
